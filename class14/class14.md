...
The first column doesn’t align with the meta data so I need to remove
it.
...
Using `rowSums()`, I can sum across the rows and see if the sum is
greater than 1.
...
There are 4349 genes up-regulated and 4396 genes down regulated with the
basic cutoff.
...
By adding a logical that looks at the pvalue adjusted, I can color the
points blue for points that are significant and have high fold change.
...
Because for KEGG and other pathways gene are not always regulated
together, I swicthed the same.dir to false for a better understanding of
the pathway.
...
```
    ...
    Info: Working in directory /Users/anna/Documents/BIMM_143/bimm143_github/class14
